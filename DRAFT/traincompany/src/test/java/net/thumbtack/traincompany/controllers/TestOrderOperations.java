...
public class TestOrderOperations extends AbstractControllerTest {
    ...
    public void testCreateOrderFailIncorrectDate() throws Exception {
        ...
        CreateOrderRequest request = new CreateOrderRequest(cl.getId(), tripId, "Omsk", "Moskow", "2022-02-32", list);
    ...
    public void testCreateOrderFailNoDate() throws Exception {
        ...
        CreateOrderRequest request = new CreateOrderRequest(cl.getId(), tripId, "Omsk", "Moskow", "rgtyuy", list);
