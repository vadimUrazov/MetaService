...
public class AdminService extends ServiceBase {
    ...
    public RegisterAdminDtoResponse registerAdmin(RegisterAdminDtoRequest request)
    ...
    public UpdateAdminDtoResponse updateAdmin(long id, UpdateAdminDtoRequest request)
            throws ServiceException {
        ...
        return new UpdateAdminDtoResponse(admin.getName(), admin.getSurname(), admin.getMiddlename(),
    ...
    public GetClientsResponse getClients() throws ServiceException {
        ...
        for (Client client : clients) {
            result.add(new ClientDtoResponse(client.getId(), client.getSurname(), client.getName(),
