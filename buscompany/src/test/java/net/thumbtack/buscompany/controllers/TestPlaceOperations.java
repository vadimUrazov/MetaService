...
public class TestPlaceOperations extends AbstractControllerTest {
    ...
    public long getTrip() throws Exception {
        ...
        AddTripRequest request = new AddTripRequest("Omsk", "Moskow", "Toyota", "18:03", "02:00", BigDecimal.valueOf(50000, 2), List.of("2022-01-03", "2022-01-02"));
    ...
    public void testChoosePlace() throws Exception {
        ...
        ChoosePlaceRequest req = new ChoosePlaceRequest(cl.getId(), response.getOrderId(), "Иван", "Иванов", 23456, 1);
    ...
    public void testChangeChoosePlace() throws Exception {
        ...
        ChoosePlaceRequest changeReq = new ChoosePlaceRequest(cl.getId(), response.getOrderId(), "Иван", "Иванов", 23456, 2);
