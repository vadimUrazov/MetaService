...
import net.thumbtack.shipcompany.dto.response.GetTripResponse;
import net.thumbtack.shipcompany.dto.response.GetTripsResponse;
...
import net.thumbtack.shipcompany.validate.TripValidator;
...
public class TestTripOperations extends AbstractControllerTest {
    ...
    public void testAddTripWithDates() throws Exception {
        ...
        assertEquals(expected.getShipDto(), trip.getShipDto());
